...
from .views import CompanyViewSet, ProductViewSet, ProductMarkingViewSet, IncomeViewSet, OutcomeViewSet, \
    UpdateMarkingView, MyTokenObtainPairView, RegisterView, logout_view, check_marking_exists, DeleteMarkingView
...
urlpatterns = [
    ...
    path('incomes/<int:income_id>/products/<int:product_id>/markings/<int:marking_id>/', DeleteMarkingView.as_view(), name='delete_marking'),
